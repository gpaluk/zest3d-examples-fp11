package plugin.examples.dlod 
{
	...
	public class DLODExample extends Zest3DApplication 
	{
		...
		override public function initialize():void 
		{
			...
			var t2:TorusPrimitive = new TorusPrimitive( reflectionEffect, false, true, 32, 16 );
			var t3:TorusPrimitive = new TorusPrimitive( reflectionEffect, false, true, 16, 8 );
			var t4:TorusPrimitive = new TorusPrimitive( reflectionEffect, false, true, 8, 4 );
