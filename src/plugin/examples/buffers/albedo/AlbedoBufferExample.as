package plugin.examples.buffers.albedo 
{
	...
	public class AlbedoBufferExample extends Zest3DApplication 
	{
		...
		override protected function initialize():void 
		{
			...
			_torus0 = new TorusPrimitive( texture2DEffect, true, false, 64, 32 );
			_torus0.x = -3;
			scene.addChild( _torus0 );
			
			_torus1 = new TorusPrimitive( texture2DEffect, true, false, 64, 32 );
			scene.addChild( _torus1 );
			
			_torus2 = new TorusPrimitive( texture2DEffect, true, false, 64, 32 );
			_torus2.x = 3;
			scene.addChild( _torus2 );
			
			var plane0:PlanePrimitive = new PlanePrimitive( texture2DEffect, true, false, 2, 2, 5, 5, true );
			plane0.rotationX = 90 * (Math.PI / 180 );
			plane0.y = 3;
			scene.addChild( plane0 );
			
			var plane1:PlanePrimitive = new PlanePrimitive( texture2DEffect, true, false, 2, 2, 5, 5, true );
