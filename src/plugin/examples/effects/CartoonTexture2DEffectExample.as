package plugin.examples.effects 
{
	 ...
	 */
	public class CartoonTexture2DEffectExample extends Zest3DApplication 
	{
		...
		override public function initialize():void 
		{
			...
			var cartoonEffect:CartoonTexture2DEffect = new CartoonTexture2DEffect( checkedTexture, gradientTexture, light );
